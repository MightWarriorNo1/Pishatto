...
const RegisterSteps: React.FC = () => {
  ...
  const handleNextStep = async () => {
    ...
    // ProfilePhoto is step 7, so completion is step 8
  ...
  const renderStep = () => {
    ...
    switch (currentStep) {
      ...
      case 8:
        console.log('RegisterSteps: Rendering Completion at step 8');
        return <Completion />;
      default:
