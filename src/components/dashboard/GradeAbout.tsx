        ...
        <div className="max-w-md mx-auto min-h-screen bg-primary pb-20">
            ...
            <div className="sticky top-0 z-50 bg-gradient-to-r from-primary via-primary to-secondary border-b border-secondary shadow-xl backdrop-blur-sm">
                <div className="flex items-center justify-between px-4 py-4">
                    <button 
                        onClick={onBack} 
                        className="flex items-center justify-center w-10 h-10 rounded-full hover:text-secondary cursor-pointer text-white transition-all duration-300 transform hover:scale-105"
                    >
                        <ChevronLeft size={24} />
                    </button>
