    ...
    return (
        <div className="max-w-md mx-auto min-h-screen bg-[#f7f8fa] pb-8">
            ...
            <div className="flex items-center px-4 py-3 border-b bg-white">
                ...
                <span className="text-base font-bold flex-1 text-center">ご利用になる前に</span>
            </div>
            {/* Heading */}
            <div className="px-4 pt-6">
                <div className="text-2xl font-bold mb-2">3つのステップを完了してください</div>
            ...
            <div className="bg-white rounded-xl mx-4 mb-4 overflow-hidden">
                <div className="flex items-center px-6 py-6">
                    ...
                    <div className="ml-4">
                        ...
                        <div className="text-lg font-bold">クレジットカード登録</div>
                    </div>
                </div>
                <div className="border-t px-6 py-3 text-orange-400 font-bold cursor-pointer">登録する</div>
            </div>
            ...
            <div className="bg-white rounded-xl mx-4 mb-4 overflow-hidden">
                <div className="flex items-center px-6 py-6">
                    ...
                    <div className="ml-4">
                        <div className="text-xs text-blue-500 font-bold mb-1">ステップ③</div>
                        <div className="text-lg font-bold">本人認証</div>
