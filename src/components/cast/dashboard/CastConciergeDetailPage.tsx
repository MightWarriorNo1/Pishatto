            ...
            <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-primary border-t border-secondary flex flex-col px-4 py-2 z-20">
                <div className="flex items-center space-x-2">
                    <input
                        ...
                        className="flex-1 w-0 min-w-0 px-4 py-2 rounded-full border border-secondary bg-white text-gray-800 text-sm placeholder-gray-400"
                        disabled={sending}
                    />
                    ...
                    <button 
                        ...
                        className="p-2 bg-secondary text-white rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
                    >
                        {sending ? (
