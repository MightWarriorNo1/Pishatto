            ...
            <div className="max-w-md w-full mx-auto bg-primary rounded-2xl shadow-lg p-8 border border-secondary">
                <div className="min-h-screen flex flex-col bg-primary">
                    ...
                    <div className="w-full px-4 pb-6">
                        <button
                            className={`w-full h-20 py-3 font-medium text-base ${isActive ? 'bg-secondary text-white hover:bg-red-700 transition-all duration-200' : 'bg-pink-400 border border-secondary text-white cursor-not-allowed'}`}
                            disabled={!isActive}
